...
# Path Setup
BRONZE_DIR = os.getenv("BRONZE_DIR", os.path.join(DATA_PATH, "bronze", "chassis_sensors"))
SILVER_DIR = os.getenv("SILVER_DIR", os.path.join(DATA_PATH, "silver", "chassis_sensors_clean"))
GOLD_DIR = os.getenv("GOLD_DIR", os.path.join(DATA_PATH, "gold", "chassis_comfort_metrics"))
