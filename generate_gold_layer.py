...
SILVER_DIR = os.getenv("SILVER_DIR", os.path.join(BASE_PATH, "data", "silver", "chassis_sensors_clean"))
GOLD_DIR = os.getenv("GOLD_DIR", os.path.join(BASE_PATH, "data", "gold", "chassis_comfort_metrics"))
